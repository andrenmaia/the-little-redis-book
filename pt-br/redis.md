...
{\colortbl;\red255\green255\blue255;\red52\green52\blue52;\red52\green52\blue52;}
\paperw11900\paperh16840\margl1440\margr1440\vieww25400\viewh15120\viewkind0
{\*\background {\shp{\*\shpinst\shpleft0\shptop0\shpright0\shpbottom0\shpfhdr0\shpbxmargin\shpbymargin\shpwr0\shpwrk0\shpfblwtxt1\shpz0\shplid1025{\sp{\sn shapeType}{\sv 1}}{\sp{\sn fFlipH}{\sv 0}}{\sp{\sn fFlipV}{\sv 0}}{\sp{\sn fillColor}{\sv 1184274}}{\sp{\sn fFilled}{\sv 1}}{\sp{\sn lineWidth}{\sv 0}}{\sp{\sn fLine}{\sv 0}}{\sp{\sn bWMode}{\sv 9}}{\sp{\sn fBackground}{\sv 1}}}}}
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardirnatural

\f0\fs28 \cf1 \cb2 # Sobre este livro\
\
## Licen\'e7a\
\
_The Little Redis Book_ est\'e1 licenciado sobre _\cb3 Attribution-NonCommercial 3.0 Unported license_. Voc\'ea n\'e3o deve pagar por este livro.\
\cb2 \
Voc\'ea \'e9 livre para copiar, distribuir, modificar ou distribuir este livro. No entanto, eu pe\'e7o que voc\'ea sempre atribua o livro a mim, Karl Seguin, e n\'e3o o use para prop\'f3sitos comerciais.\
\
Voc\'ea pode ver o **texto completo** sobre **a licen\'e7a** em: \cb3 <http://creativecommons.org/licenses/by-nc/3.0/legalcode>\cb2 \
\
\
## Sobre o Autor\
\
Karl Seguin \'e9 um desenvolvedor com experi\'eancia em diversas \'e1reas e tecnologias. Ele \'e9 um contribuinte ativo de projetos de \cb3 __\cb2 software open-source__ (c\'f3digo aberto), um escritor t\'e9cnico e, ocasionalmente, um palestrante. Ele escreveu v\'e1rios artigos, bem como algumas ferramentas, sobre o Redis. O Redis lidera o ranking e estat\'edstica de seu servi\'e7o gratuito para jogadores casuais: \cb3 [mogade.com](http://mogade.com/).\cb2 \
\
Karl escreveu \cb3 [The Little MongoDB Book](http://openmymind.net/2011/3/28/The-Little-MongoDB-Book/), o gratuito e popular livro sobre MongoDB.\cb2 \
\
Seu blog pode ser visto em \cb3 <http://openmymind.net> e seus tweets em [@karlseguin](http://twitter.com/karlseguin)\cb2 \
\
## Agradecimentos\
\
Um agradecimento especial a \cb3 [Perry Neal](https://twitter.com/perryneal)  por me emprestar seus olhos, mente e paix\'e3o. Voc\'ea me proveu inestim\'e1vel aux\'edlio. Obrigado. \cb2 \
\
## \'daltima vers\'e3o \
\
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardirnatural
\cf1 \cb3 A \'faltima vers\'e3o deste livro \'e9 dispon\'edvel em:\
<http://github.com/karlseguin/the-little-redis-book>\
\pard\tx566\tx1133\tx1700\tx2267\tx2834\tx3401\tx3968\tx4535\tx5102\tx5669\tx6236\tx6803\pardirnatural
\cf1 \cb2 \
# Introdu\'e7\'e3o \
\
Ao longo dos \'faltimos anos, as t\'e9cnicas e ferramentas utilizadas para persistir e consultar dados t\'eam crescido a um ritmo incr\'edvel. Embora seja seguro dizer que bancos de dados relacionais n\'e3o v\'e3o a lugar algum, tamb\'e9m podemos dizer que o ecossistema em torno dos dados nunca vai ser o mesmo.\
\
De todas as novas ferramentas e solu\'e7\'f5es, para mim, Redis tem sido a mais emocionante. Por qu\'ea? Primeiro porque \'e9 inacreditavelmente f\'e1cil de aprender. Hora \'e9 a unidade certa para usar quando se fala sobre a quantidade de tempo que se leva para se acostumar com o Redis. Em segundo lugar, ele resolve um conjunto espec\'edfico de problemas ao mesmo tempo que \'e9 bastante gen\'e9rico. O que exatamente isso quer dizer? O Redis n\'e3o tenta ser todas as coisas para todos os dados. \'c0 medida que voc\'ea come\'e7a a conhecer o Redis, se tornar\'e1 incrivelmente evidente o que ele faz e o que n\'e3o pertence a ele. E quando isso acontecer, como um desenvolvedor,  ser\'e1 uma grande experi\'eancia.\
\
